...
from .serializers import doctorRegistrationSerializerAdmin, doctorRegistrationProfileSerializerAdmin, doctorProfileSerializerAdmin, doctorAccountSerializerAdmin, appointmentSerializerAdmin, patientRegistrationSerializerAdmin, patientRegistrationProfileSerializerAdmin, patientProfileSerializerAdmin, patientAccountSerializerAdmin, patientCostSerializer, patientHistorySerializerAdmin
...
class docregistrationViewAdmin(APIView):
    ...
    def post(self, request, format=None):
        registrationSerializer = doctorRegistrationSerializerAdmin(data=request.data.get('user_data'))
        profileSerializer = doctorRegistrationProfileSerializerAdmin(data=request.data.get('profile_data'))
...
class doctorAccountViewAdmin(APIView):
    """API endpoint for getiing info of all/particular doctor, update/delete doctor's info - only accessible by Admin"""
...
class approvePatientViewAdmin(APIView):
    """API endpoint for getting new patient request, update and delete approval requests - only accessible by Admin"""
...
class appointmentViewAdmin(APIView):
    """API endpoint for getting info of all/particular appointment, update/delete appointment - only accessible by Admin"""
