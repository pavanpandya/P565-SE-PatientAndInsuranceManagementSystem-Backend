from .views import CustomAuthToken, doctorAccountViewAdmin, docregistrationViewAdmin, approveDoctorViewAdmin,  appointmentViewAdmin, patientRegistrationViewAdmin, patientAccountViewAdmin, patientHistoryViewAdmin, approvePatientViewAdmin, approveAppointmentViewAdmin
